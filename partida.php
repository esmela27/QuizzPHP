...
<div class='container'>
    <div class='row'>
        <div class='col-12'>
            ...
            <br><br>
            <button class="btn btn-warning col-12 "  onclick="chequeaRespuesta ('1','<?php echo $r['numero']; ?>');">
                <?php echo $r['r1']; ?>
            </button>
            <br>
            <button class="btn btn-warning col-12" onclick="chequeaRespuesta ('2','<?php echo $r['numero']; ?>');">
                <?php echo $r['r2']; ?>
            </button>
            <br>
            <button class="btn btn-warning  col-12" onclick="chequeaRespuesta ('3','<?php echo $r['numero']; ?>');">
                <?php echo $r['r3']; ?>
            </button>
            <br>
            <button class="btn btn-warning  col-12" onclick="chequeaRespuesta ('4','<?php echo $r['numero']; ?>');">
                <?php echo $r['r4']; ?>
            </button>
            <br>
